...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='lastfm_gcn_fairness',
    ...
    parser.add_argument('--log_path', type=str, default='logs/lastfm/gcn/gcn_fairness_lastfm_' + str(time_stamp) + '.txt')
    parser.add_argument('--param_path', type=str, default='param/lastfm/gcn/gcn_fairness_lastfm_' + str(time_stamp) + '.pth')
    ...
    parser.add_argument('--u_threshold', type=float, default=0.7)
    parser.add_argument('--l_threshold', type=float, default=0.2)
