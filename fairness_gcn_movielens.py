...
if __name__ == '__main__':
    ...
    torch.set_printoptions( precision=4,edgeitems=10,sci_mode=False,linewidth=80)
    ...
    parser.add_argument('--log_path', type=str, default='logs/ml/gcn/gcn_fairness_' + str(time_stamp) + '.txt')
    parser.add_argument('--param_path', type=str, default='param/ml/gcn/gcn_fairness_' + str(time_stamp) + '.pth')
