...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/ml/gcn/gcn_fairness_gender_' + str(time_stamp) + '.txt')
    parser.add_argument('--param_path', type=str,
                        default='param/ml/gcn/gcn_fairness_gender_' + str(time_stamp) + '.pth')
    ...
    parser.add_argument('--s_reg', type=float, default=0.1)
    parser.add_argument('--d_reg', type=float, default=1.0)
    parser.add_argument('--c_reg', type=float, default=1.0)
    parser.add_argument('--equ_reg', type=float, default=0.1)
