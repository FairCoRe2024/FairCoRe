...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/ml/bprmf/bpr_fairness_' + str(time_stamp) + '.txt')
    parser.add_argument('--param_path', type=str, default='param/ml/bprmf/bpr_fairness_' + str(time_stamp) + '.pth')
